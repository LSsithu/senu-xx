...
console.log("Connecting SENU QUEEN BOT 🤖...");
...
conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://telegra.ph/file/cbf3858a08efefa2d1d47.jpg` }, caption: up })
...
if(senderNumber.includes("94715961420")){
if(isReact) return
m.react("🤖")
}       
//=====================✓
...
app.get("/", (req, res) => {
res.send("hey, SENU QUEEN started✅");
});
